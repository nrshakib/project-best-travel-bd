		...
		<div class="container">
			<nav class="navbar navbar-default navbar-fixed-top">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">BEST TRAVEL <span>BD</span><p class="logo_w3l_agile_caption">ALL YOU WANT</p></a></h1>
				</div>
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4>BEST TRAVEL  <span>BD</span></h4>
										<img src="images/about2.jpg" alt=" " class="img-responsive">
										<h5>GET OUR ADVANCED SERVICES</h5>
										<p>We Serve The Users to View Their Expected Places,Nearby Hotels of The Places and Vehicles to Select and Book.</p>
									</div>
								</div>
							</div>
						</div>
...
HOT WINTER OFFER 2022 !!!         OFF 20% FOR ROOMS !!!  OFF 15% IN CAR RENT !!!   OFF 10% IN FOOD ITEMS !!!  SPECIAL BLOG SITE !!!
</marquee></a>
</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">BEST TRAVEL BD</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">ABOUT BEST TRAVEL BD</h3> 
						   <p class="about-para-w3ls">The Users can search and View Their Expected Places. They can also find Nearby Hotels of The Places, Special Food Items and Vehicles to Select and Book.</p>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+880 13122 58227</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">sazib.diucse@gmail.com</a></p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2022 BEST TRAVEL BD . All Rights Reserved | Design by <a href="index.php">SHAKIB, SAZIB & ARONI</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
